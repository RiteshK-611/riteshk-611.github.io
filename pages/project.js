      ...
      <div className="w-screen h-[30vh] lg:h-[40vh] relative">
        <div className="absolute top-0 left-0 w-full h-[30vh] lg:h-[40vh] bg-black/80">
          <Image
            ...
            alt="/"
          />
          <div className="absolute top-[70%] max-w-[1240p] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white p-2">
            <h2 className="py-2">Project Name</h2>
            <h3>React / Tailwind / Firebase</h3>
          </div>
        </div>
      </div>
      <div className="max-w-[1240p] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
        ...
        <div className="col-span-4 md:col-span-1 shadow-xl shadow-gray-400 rounded-xl p-4">
          <div className="p-2">
            ...
            <div className="grid grid-cols-3 md:grid-cols-1">
              ...
              <p className="text-gray-600 flex items-center py-2">
                <RiRadioButtonFill className="pr-1" /> Netflix
              </p>
              <p className="text-gray-600 flex items-center py-2">
